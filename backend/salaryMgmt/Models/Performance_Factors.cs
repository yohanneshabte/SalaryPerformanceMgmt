...
namespace salaryMgmt.Models
{
    ...
    {
        //public PerformanceFactorsDTO P_factorsDTO { get; set; }
        //private DatabaseGateway db;

        //public Performance_Factors(int id)
        //{
        //    P_factorsDTO = new PerformanceFactorsDTO();
        ...
        //        P_factorsDTO.factorName = p_factors.GetString(p_factors.GetOrdinal("factor_name"));
        //        P_factorsDTO.factorDimensionS = p_factors.GetString(p_factors.GetOrdinal("factor_dimensions"));
